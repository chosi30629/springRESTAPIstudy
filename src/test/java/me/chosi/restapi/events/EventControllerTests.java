...
import me.chosi.restapi.common.RestDocsConfiguration;
...
public class EventControllerTests {
    ...
    public void createEvent() throws Exception {
        EventDto event = EventDto.builder()
                ...
                .beginEnrollmentDateTime(LocalDateTime.of(2019, 8, 1, 14, 21))
                .closeEnrollmentDateTime(LocalDateTime.of(2019, 8, 8, 14, 21))
                .beginEventDateTime(LocalDateTime.of(2019, 8, 15, 14, 21))
                .endEventDateTime(LocalDateTime.of(2019, 8, 22, 14, 21))
                .basePrice(100)
                .maxPrice(200)
    ...
    public void createEvent_Bad_Request_Wrong_Input() throws Exception {
        EventDto eventDto = EventDto.builder()
                .name("Spring")
                .description("REST API Development with Spring")
                .beginEnrollmentDateTime(LocalDateTime.of(2019, 8, 9, 14, 21))
                .closeEnrollmentDateTime(LocalDateTime.of(2019, 8, 8, 14, 21))
                .beginEventDateTime(LocalDateTime.of(2019, 8, 23, 14, 21))
                .endEventDateTime(LocalDateTime.of(2019, 8, 22, 14, 21))
                .basePrice(10000)
                .maxPrice(200)
                .limitOfEnrollment(100)
    ...
    public void getEvent404() throws Exception {
        ...
        // When & Then
        this.mockMvc.perform(get("/api/events/340312"))
    ...
    public void updateEvent404() throws Exception {
        ...
        // When & Then
        this.mockMvc.perform(put("/api/events/211221")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound());
